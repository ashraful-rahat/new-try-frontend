            ...
            >
              ...
              <div className="relative h-64 bg-gray-200 overflow-hidden">
                ...
                <div className="relative w-full h-full">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-br from-gray-300 to-gray-400 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
